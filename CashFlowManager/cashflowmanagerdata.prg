...
*  DescripciÔøΩn:
*  Generador de Flujo de Caja semanal dinÔøΩmico basado en SQL.
*  La lÔøΩgica financiera vive en SQL.
*  VFP solo dibuja estructura y fÔøΩrmulas en Excel.
*===========================================================
*-----------------------------------------------------------
* PALETA DE COLORES
*-----------------------------------------------------------
...
* Recibe a√±o e ISO semana. Calcula la fecha del lunes de
...
FUNCTION GenerarCashFlowExcel
    ...
    TRY
        ...
        WAIT WINDOW "Inicializando generaciÛn de Flujo de Caja..." NOWAIT  && NUEVO
    ...
    CATCH TO loError
        ...
        lcErrorDetalle = ;
            ...
            "LÔøΩnea: " + TRANSFORM(loError.LineNo)
...
*-----------------------------------------------------------
* 1) ARMA ENCABEZADO
* Dibuja tÔøΩtulo y estructura visual superior.
*-----------------------------------------------------------
...
*-----------------------------------------------------------
* Dibuja subtotal por columna usando fÔøΩrmula SUM
*-----------------------------------------------------------
...
*-----------------------------------------------------------
* Convierte nÔøΩmero de columna a letra (A,B,C,...,AA)
*-----------------------------------------------------------
...
* Devuelve la TRM para una fecha especÔøΩfica.
*-----------------------------------------------------------
FUNCTION ObtenerTRM
    LPARAMETERS tdFecha
